<?php
	class DatabaseMySQL extends LoggerBase {
		private $_db = false;
		...
		function close() {
			if (!@mysql_close($this->_db))
				return $this->log(TYPE_ERROR, __CLASS__.'::'.__FUNCTION__, 'Error closing database', 'Cannot close database connection');

			$this->log(TYPE_INFO, __CLASS__.'::'.__FUNCTION__, 'Database closed', 'Database has been closed');
			return true;
		}
